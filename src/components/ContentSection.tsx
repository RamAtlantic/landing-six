      ...
      <section className="container mx-auto px-3 lg:px-0 py-2">
        <div className="flex flex-col md:flex-row items-center justify-center w-full">
          ...
          <div className="flex flex-col md:w-2/5 space-y-8">
            ...
            <motion.div
              className="flex bg-black rounded-lg p-4 md:p-8 border border-gray-700 items-center justify-center flex-col relative overflow-hidden cursor-pointer group hover:border-yellow-500 hover:shadow-lg transition-all duration-500 ease-in-out"
              onClick={handleRegistration}
              whileHover={{ scale: 1.02 }}
              transition={{ duration: 0.3 }}
            >
              <FaUserPlus className="text-3xl mb-4 text-yellow-400" />
              ...
              <div className="relative z-10">
                {loadingStates["button1"] ? (
                  ...
                  <motion.h3
                    className="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-green-400 to-yellow-400 bg-clip-text text-transparent mb-3 lg:mb-4 font-chango text-center group-hover:text-black"
                    whileHover={{
                ...
                <motion.p
                  className="text-xl lg:text-2xl text-white leading-tight text-center group-hover:text-black transition-colors duration-300"
                  whileHover={{ scale: 1.02 }}
                >
